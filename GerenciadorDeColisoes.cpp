...
/**
bool GerenciadorDeColisoes::checkCollision(Obstaculo_Movel* parada, Jogador* movimentavel, sf::Vector2f& direction, float push) {
    sf::Vector2f otherPosition = movimentavel->getPosition();
    sf::Vector2f otherHalfSize = movimentavel->getHalfSize();
    sf::Vector2f thisPosition = parada->getPosition();
    sf::Vector2f thisHalfSize = parada->getHalfSize();
...
bool GerenciadorDeColisoes::checkCollision(Obstaculo_Espinho* parada, Jogador* movimentavel, sf::Vector2f& direction, float push) {
    sf::Vector2f otherPosition = movimentavel->getPosition();
    sf::Vector2f otherHalfSize = movimentavel->getHalfSize();
    sf::Vector2f thisPosition = parada->getPosition();
    sf::Vector2f thisHalfSize = parada->getHalfSize();
