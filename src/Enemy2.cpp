...
Enemy2::Enemy2(const char* textureFile, float speed, float jumpHeight)
{
	...
	InitializeEnemy2(position, size, textureFile, imgCount, speed, jumpHeight);
}
...
void Enemy2::InitializeEnemy2(sf::Vector2f position, sf::Vector2f size, const char * textureFile, sf::Vector2u imgCount, float speed, float jumpHeight)
{
