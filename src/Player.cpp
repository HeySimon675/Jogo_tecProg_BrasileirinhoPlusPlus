...
{
	{
		...
		if (sf::Keyboard::isKeyPressed(KeyLeft) && sf::Keyboard::isKeyPressed(sf::Keyboard::LShift))
			velocity.x -= speed*2;
		if (sf::Keyboard::isKeyPressed(KeyRight) && sf::Keyboard::isKeyPressed(sf::Keyboard::LShift))
			velocity.x += speed*2;
